...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    const avatar = await uploadOnCloudinary(avatarLocalPath);
    if (!avatar.url) {
        throw new ApiError(400, "Error while uploading avator on cluodinary")
    }
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    if (!coverImage.url) {
        throw new ApiError(400, "Error while uploading cover image on cluodinary")
    }
...
// Todo-  Delete old images on cloudinary after updating
